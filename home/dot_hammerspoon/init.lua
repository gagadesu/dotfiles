...
if spoon.WinWin then
	...
	cmodal:bind("shift", "left", "Move to Left Monitor", function()
		spoon.WinWin:stash()
		spoon.WinWin:moveToScreen("left")
	end)
	cmodal:bind("shift", "right", "Move to Right Monitor", function()
		spoon.WinWin:stash()
		spoon.WinWin:moveToScreen("right")
	end)
	cmodal:bind("shift", "up", "Move to Above Monitor", function()
		spoon.WinWin:stash()
		spoon.WinWin:moveToScreen("up")
	end)
	cmodal:bind("shift", "down", "Move to Below Monitor", function()
		spoon.WinWin:stash()
		spoon.WinWin:moveToScreen("down")
	end)
	cmodal:bind("shift", "space", "Move to Next Monitor", function()
		spoon.WinWin:stash()
